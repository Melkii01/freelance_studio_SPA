...
export class Router {
    ...
    // Функция при клике на любом месте страницы
    ...
    async activateRoute(e, oldRoute = null) {
        ...
        if (oldRoute) {
            ...
            // Удаляем старые стили с покинутой странички
            ...
            // Удаляем старые скрипты с покинутой странички
            ...
            // Запускаем функцию выгрузки страницы, если она есть
        ...
        if (newRoute) {
            ...
            // Если есть скрипты добавляем на страничку
            ...
            if (newRoute.filePathTemplate) {
                ...
                if (newRoute.useLayout) {
                    ...
                    // Отображаем пользователя на сайдбаре
    ...
    // Активная ссылка на сайдбаре при открытой странице
