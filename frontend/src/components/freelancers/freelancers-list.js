    ...
    showRecords(freelancers) {
        ...
        for (let i = 0; i < freelancers.length; i++) {
            ...
            trElement.insertCell().innerHTML =
                freelancers[i].avatar ? '<img class="freelancer-avatar" src="' + config.host + freelancers[i].avatar + '" alt="User Image">' : '';
